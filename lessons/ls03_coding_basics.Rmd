...
There are two main type of text in an R script: commands and comments. A command is a line or lines of R code that instructs R to do something (e.g. `2 + 2`)
...
diabetes_china # print diabetes_china
```
...
```{r}
first_name <- "Luigi"
paste("My name is", first_name, "any my last name is " last_name)
```
...
Which of the following is correct interpretation of what this code means:
...
@TO-DO Go over learning objectives again.
