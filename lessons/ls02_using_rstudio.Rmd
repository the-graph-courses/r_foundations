...
For now, it is important to know that to use a package, you need to *install* then *load* it.

All the package names you see (in blue font) are packages that are installed on your system. And packages with a checkmark are packages which are *loaded*.
...
-   First, under `Appearance`, choose your ideal theme. (We like the "Crimson Editor" and "Tomorrow Night" themes.)
...
-   Also under `Code > Display`, check "Rainbow parentheses". What this does is make your "nested parentheses" easier to read by giving each pair a unique color.
    ...
    ![](images/options_highlight_function_rainbow_parentheses.jpg){width="446"}![](images/highlight_r_function_calls.jpg){width="460" height="66"}
